...
if __name__ == '__main__':
    ...
    models = {
        ...
        "MLP - Relu-camadas (1) e neurônios (50)": MLPClassifier(activation='relu', hidden_layer_sizes=(50,)),
        ...
        "MLP - Logistic-camadas (3) e neurônios(50)": MLPClassifier(activation='logistic',
                                                                    hidden_layer_sizes=(50, 50, 50)),
        "MLP - TanHip-camadas (3) e neurônios(50)": MLPClassifier(activation='tanh', hidden_layer_sizes=(50, 50, 50)),
        "MLP - Relu-camadas(6) e neurônios (50)": MLPClassifier(activation='relu',
                                                                hidden_layer_sizes=(50, 50, 50, 50, 50, 50)),
        "MLP - Logistic-camadas (6) e neurônios(50)": MLPClassifier(activation='logistic',
                                                                    hidden_layer_sizes=(50, 50, 50, 50, 50, 50)),
        "MLP - TanHip-camadas (6) e neurônios(50)": MLPClassifier(activation='tanh',
                                                                  hidden_layer_sizes=(50, 50, 50, 50, 50, 50)),
        "MLP - Relu-camadas (1) e neurônios (100)": MLPClassifier(activation='relu', hidden_layer_sizes=(100,)),
        "MLP - Logistic-camadas (1) e neurônios(100)": MLPClassifier(activation='logistic', hidden_layer_sizes=(100,)),
        "MLP - TanHip-camadas (1) e neurônios(100)": MLPClassifier(activation='tanh', hidden_layer_sizes=(100,)),
        "MLP - Relu-camadas(3) e neurônios (100)": MLPClassifier(activation='relu', hidden_layer_sizes=(100, 100, 100)),
        "MLP - Logistic-camadas (3) e neurônios(100)": MLPClassifier(activation='logistic',
                                                                     hidden_layer_sizes=(100, 100, 100)),
        "MLP - TanHip-camadas (3) e neurônios(100)": MLPClassifier(activation='tanh',
                                                                   hidden_layer_sizes=(100, 100, 100)),
        "MLP - Relu-camadas(6) e neurônios (100)": MLPClassifier(activation='relu',
                                                                 hidden_layer_sizes=(100, 100, 100, 100, 100, 100)),
        "MLP - Logistic-camadas (6) e neurônios(100)": MLPClassifier(activation='logistic',
                                                                     hidden_layer_sizes=(100, 100, 100, 100, 100, 100)),
        "MLP - TanHip-camadas (6) e neurônios(100)": MLPClassifier(activation='tanh',
                                                                   hidden_layer_sizes=(100, 100, 100, 100, 100, 100)),
        "MLP - Relu-camadas (1) e neurônios (150)": MLPClassifier(activation='relu', hidden_layer_sizes=(150,)),
        ...
        "MLP - Logistic-camadas (3) e neurônios(150)": MLPClassifier(activation='logistic',
                                                                     hidden_layer_sizes=(150, 150, 150)),
        "MLP - TanHip-camadas (3) e neurônios(150)": MLPClassifier(activation='tanh',
                                                                   hidden_layer_sizes=(150, 150, 150)),
        "MLP - Relu-camadas(6) e neurônios (150)": MLPClassifier(activation='relu',
                                                                 hidden_layer_sizes=(150, 150, 150, 150, 150, 150)),
        "MLP - Logistic-camadas (6) e neurônios(150)": MLPClassifier(activation='logistic',
                                                                     hidden_layer_sizes=(150, 150, 150, 150, 150, 150)),
        "MLP - TanHip-camadas (6) e neurônios(150)": MLPClassifier(activation='tanh',
                                                                   hidden_layer_sizes=(150, 150, 150, 150, 150, 150)),
        "KNN com k=1": KNeighborsClassifier(n_neighbors=1, algorithm='ball_tree', metric=cosseno),
        "KNN com k=2": KNeighborsClassifier(n_neighbors=2, algorithm='ball_tree', metric=cosseno),
        "KNN com k=3": KNeighborsClassifier(n_neighbors=3, algorithm='ball_tree', metric=cosseno),
        "KNN com k=4": KNeighborsClassifier(n_neighbors=4, algorithm='ball_tree', metric=cosseno),
        "KNN com k=5": KNeighborsClassifier(n_neighbors=5, algorithm='ball_tree', metric=cosseno),
        "KNN com k=6": KNeighborsClassifier(n_neighbors=6, algorithm='ball_tree', metric=cosseno),
        "KNN com k=7": KNeighborsClassifier(n_neighbors=7, algorithm='ball_tree', metric=cosseno),
        "KNN com k=8": KNeighborsClassifier(n_neighbors=8, algorithm='ball_tree', metric=cosseno),
        "KNN com k=9": KNeighborsClassifier(n_neighbors=9, algorithm='ball_tree', metric=cosseno),
        "KNN com k=10": KNeighborsClassifier(n_neighbors=10, algorithm='ball_tree', metric=cosseno),
        "KNN com k=11": KNeighborsClassifier(n_neighbors=11, algorithm='ball_tree', metric=cosseno),
        "KNN com k=12": KNeighborsClassifier(n_neighbors=12, algorithm='ball_tree', metric=cosseno),
        "KNN com k=13": KNeighborsClassifier(n_neighbors=13, algorithm='ball_tree', metric=cosseno),
        "KNN com k=14": KNeighborsClassifier(n_neighbors=14, algorithm='ball_tree', metric=cosseno),
        "KNN com k=15": KNeighborsClassifier(n_neighbors=15, algorithm='ball_tree', metric=cosseno),
        "KNN com k=16": KNeighborsClassifier(n_neighbors=16, algorithm='ball_tree', metric=cosseno),
        "KNN com k=17": KNeighborsClassifier(n_neighbors=17, algorithm='ball_tree', metric=cosseno),
        "KNN com k=18": KNeighborsClassifier(n_neighbors=18, algorithm='ball_tree', metric=cosseno),
        "KNN com k=19": KNeighborsClassifier(n_neighbors=19, algorithm='ball_tree', metric=cosseno),
        "KNN com k=20": KNeighborsClassifier(n_neighbors=20, algorithm='ball_tree', metric=cosseno),
        "KNN com k=21": KNeighborsClassifier(n_neighbors=21, algorithm='ball_tree', metric=cosseno),
        "KNN com k=22": KNeighborsClassifier(n_neighbors=22, algorithm='ball_tree', metric=cosseno),
        "KNN com k=23": KNeighborsClassifier(n_neighbors=23, algorithm='ball_tree', metric=cosseno),
        "KNN com k=24": KNeighborsClassifier(n_neighbors=24, algorithm='ball_tree', metric=cosseno),
        "KNN com k=25": KNeighborsClassifier(n_neighbors=25, algorithm='ball_tree', metric=cosseno),
        "KNN com k=26": KNeighborsClassifier(n_neighbors=26, algorithm='ball_tree', metric=cosseno),
        "KNN com k=27": KNeighborsClassifier(n_neighbors=27, algorithm='ball_tree', metric=cosseno),
        "KNN com k=28": KNeighborsClassifier(n_neighbors=28, algorithm='ball_tree', metric=cosseno),
        "KNN com k=29": KNeighborsClassifier(n_neighbors=29, algorithm='ball_tree', metric=cosseno),
        "KNN com k=30": KNeighborsClassifier(n_neighbors=30, algorithm='ball_tree', metric=cosseno),
        ...
        "MNB - alpha 0.8 e fit_prior": MultinomialNB(alpha=0.8, fit_prior=True),
        "MNB - alpha 0.8": MultinomialNB(alpha=0.8, fit_prior=False),
        "MNB - alpha 0.7 e fit_prior": MultinomialNB(alpha=0.7, fit_prior=True),
        "MNB - alpha 0.7": MultinomialNB(alpha=0.7, fit_prior=False),
        "MNB - alpha 0.6 e fit_prior": MultinomialNB(alpha=0.6, fit_prior=True),
        "MNB - alpha 0.6": MultinomialNB(alpha=0.6, fit_prior=False),
        ...
        "MNB - alpha 0.3 e fit_prior": MultinomialNB(alpha=0.3, fit_prior=True),
        "MNB - alpha 0.3": MultinomialNB(alpha=0.3, fit_prior=False),
        "MNB - alpha 0.2 e fit_prior": MultinomialNB(alpha=0.2, fit_prior=True),
        "MNB - alpha 0.2": MultinomialNB(alpha=0.2, fit_prior=False),
